...
import { ShieldCheck, Bell, Menu, UserCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-3 flex justify-between items-center sticky top-0 z-50 shadow-sm">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800 tracking-tight">手卫生依从性 <span className="text-blue-600">统计分析平台</span></h1>
        ...
        <div className="flex items-center space-x-6">
            <nav className="hidden md:flex space-x-6 text-sm font-medium text-slate-500">
                <a href="#" className="text-blue-600 hover:text-blue-700">仪表盘</a>
                <a href="#" className="hover:text-slate-800 transition-colors">统计报表</a>
